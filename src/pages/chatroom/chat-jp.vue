<template>
  <div class="wrap">
    ...
    <ul class="content">
      <li v-for="item in list" :class="[item.language == 'jp' ? 'own':'any']"><img v-if="item.language!='jp'" :src="item.image" alt=""><span :class="[item.language == 'jp' ? 'own':'any']">{{item.message}}</span><img v-if="item.language=='jp'" :src="item.image" alt=""></li>
    </ul>

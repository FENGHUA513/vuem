<template>
  <div class="wrap">
    ...
    <ul class="content">
      <li v-for="item in list" :class="[item.language == 'fra' ? 'own':'any']"><img v-if="item.language!='fra'" :src="item.image" alt=""><span :class="[item.language == 'fra' ? 'own':'any']">{{item.message}}</span><img v-if="item.language=='fra'" :src="item.image" alt=""></li>
    </ul>
